...
.. questionnote::
 ...
 Написати упит којим се приказују ознака модела и назив произвођача возила која имају петора
...
.. questionnote::
 ...
 Написати упит којим се приказују ознака модела, назив произвођача, назив и опис категорије за
...
.. questionnote::
 ...
 Написати упит којим се приказује ознака модела за све лимузине произвођача Mercedes-Benz.
...
.. questionnote::
 ...
 Написати упит којим се абецедно уређено приказују произвођачи модела који користе дизел.
...
.. questionnote::
 ...
 Написати упит којим се абецедно уређено приказују произвођачи џипова.

...
.. questionnote::
 ...
 Написати упит којим се, уз инвентарски број, приказује и назив књиге тог примерка. Уредити
...
.. questionnote::
 ...
 Написати упит којим се, уз инвентарски број, приказује и назив књиге тог примерка и назив
...
.. questionnote::
 ...
 Написати упит којим се приказују називи књига издавача чији је назив CET.
...
.. questionnote::
 ...
 Написати упит којим се приказују инвентарски бројеви примерака књига издавача чији је назив CET.
...
.. questionnote::
 ...
 Написати упит којим се приказују имена и презимена аутора који су писали књиге за издавача
...
.. questionnote::
 ...
 Написати упит којим се приказују имејл запосленог у библиотеци и имејл његовог менаџера.
...
.. questionnote::
 ...
 Написати упит којим се приказују подаци о свим позајмицама: име, презиме и телефон члана,
...
.. questionnote::
 ...
 Написати упит којим се приказују подаци о свим тренутним позајмицама: име, презиме и имејл
...
.. questionnote::
 ...
 Написати упит којим се приказују датуми позајмица књига чији је аутор Марко Видојковић.
...
.. questionnote::
 ...
 Написати упит којим се приказују називи књигa које је из библиотеке узимао члан са бројем
...
.. questionnote::
 ...
 Написати упит којим се приказују називи књигa које је из библиотеке узимао члан „Милица
...
.. questionnote::
 ...
 Написати упит којим се приказују имена чланова библиотеке и називи издавача чије су књиге
...
.. questionnote::
 ...
 Написати упит којим се приказују имејл адресе чланова који су узимали из библиотеке књиге у
...
.. questionnote::
 ...
 Написати упит којим се приказују бројеви телефона чланова којима је издата казна за неку позајмицу. 

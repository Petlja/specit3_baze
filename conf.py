...
project = 'Базе података за 3. разред специјализованих ИТ одељења'
...
html_context = {'course_id': 'specit3_baze',
...
html_theme_options = {
    ...
    'navbar_title': "Базе података за 3. разред специјализованих ИТ одељења",
...
html_title = 'Базе података за 3. разред специјализованих ИТ одељења'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title ='Базе података за 3. разред специјализованих ИТ одељења'
...
htmlhelp_basename = 'specit3_baze-doc'

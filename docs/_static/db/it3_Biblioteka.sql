...
( broj_clanske_karte INTEGER PRIMARY KEY, 
ime VARCHAR(15) NOT NULL, 
prezime VARCHAR(15) NOT NULL, 
...
( broj_clanske_karte INTEGER REFERENCES clanovi(broj_clanske_karte), 
...
( inventarski_broj INTEGER PRIMARY KEY, 
id_knjige INTEGER NOT NULL REFERENCES knjige(id_knjige) );

CREATE TABLE autori_knjige
(id_autora INTEGER REFERENCES autori(id_autora),
...
id_menadzera INTEGER REFERENCES zaposleni(id) );

CREATE TABLE pozajmice
( inventarski_broj INTEGER REFERENCES primerci(inventarski_broj), 
broj_clanske_karte INTEGER REFERENCES clanovi(broj_clanske_karte), 
datum_uzimanja DATE, 
datum_vracanja DATE, 
id_zaposlenog INTEGER NOT NULL REFERENCES zaposleni(id),
PRIMARY KEY (inventarski_broj, broj_clanske_karte, datum_uzimanja), 
CHECK (datum_vracanja >= datum_uzimanja) );

CREATE TABLE kazne
( id_kazne INTEGER PRIMARY KEY,
iznos INTEGER NOT NULL,
datum DATE NOT NULL,  
inventarski_broj INTEGER NOT NULL, 
broj_clanske_karte INTEGER NOT NULL, 
